'''
Source: https://github.com/alebryvas/berk266/blob/master/preprocess/process.py
...
for row in range(rows):
    abstract = Data.loc[row,'talk__description']
    ...
    if len(article) > 20:
        ...
        with open(path+'/'+'temporaryFile.txt','wb') as t:
            t.write(abstract)
        ...
        filename = Data.loc[row,'talk__name']
        ...
        with open(path+'/'+filename1,'wb') as f:
            ...
            with open(path+'/'+'temporaryFile.txt','r', encoding="utf8") as t: # Bryan added encoding
                for line in t:
                    line=line.lower()
                    if line != "\n" and line != "\t" and line != " ":
                        f.write(b'@summary'+b'\n')
